...
class RegisterProductTest {
    ...
    public static class Product {
        ...
        public Product(final String name,
            ...
            validateConstructor(name, code, description, brand, maker, origin, category, temperatureZone, weightInGrams);
        ...
        private void validateConstructor(final String name,
                                         final String code,
                                         final String description,
                                         final String brand,
                                         final String maker,
    ...
    public static class ProductSize {
        ...
        public ProductSize(final Long widthInMillimeters,
            ...
            validateProductSize(widthInMillimeters,
                    heightInMillimeters,
                    lengthInMillimeters);
        ...
        private void validateProductSize(final Long widthInMillimeters,
                                         final Long heightInMillimeters,
                                         final Long lengthInMillimeters) {
            Assert.notNull(widthInMillimeters, "가로길이는 필수입니다.");
            if (0 > widthInMillimeters) {
